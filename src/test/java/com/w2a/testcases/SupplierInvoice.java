...
public class SupplierInvoice extends TestBase {

	@Test(dataProvider = "getData")
	public void supplierInvoice(String typeName, String accountCode, String subsidieryType, String nature,
			String status, String description, String runmode) throws InterruptedException, IOException {
		
		 if(!TestUtil.isTestRunnable("supplierInvoice", excel)) {
			 throw new SkipException("Skipping the test "+"supplierInvoice"+" as the Run mode is No ");
		 }

		// verifyEquals("ABC", "XYZ");
		
		if (!"http://192.168.1.32:8080/HoneycombWeb/#/purchase/supplierinvoice".equals(driver.getCurrentUrl())) {
			Actions builder = new Actions(driver);
			click("Purchase_CSS");
			click("SupplierInvoice_CSS");
		}
		...
		Thread.sleep(3000);
		click("AddSupplierInvoice_XPATH");
		Thread.sleep(3000);
...
//		Thread.sleep(3000);
	...
	public Object[][] getData() {
		String sheetName = "supplierInvoice";
